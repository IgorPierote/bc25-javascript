/*
    ...
    se ele fordivisível por 400, ele volta a ser bissexto.
...
const num = parseInt(prompt('Insira o ano que deseja verificar se é ou não bissexto'))

if(num % 400 == 0 || num % 4 == 0 && num % 100 != 0 ){
    document.write(`<p>O ano ${num} é bissexto</p>`)
}else{
    document.write(`<p>O ano ${num} não é bissexto</p>`)
